...
- `Stella Ship Asset` --conceptually_related_to--> `Hangar Page (Fleet/Resources)`  [INFERRED]
  frontend/public/assets/ships/stella.png → spec.md
...
- **Tier Progression System (T1-T5)** — fuel_t1_mangan_hydride, fuel_t2_methane_fraction, fuel_t3_dark_matter, fuel_t4_singularity_ether, fuel_t5_dark_energy, zone_inner_rim, zone_nebula_belt, zone_frontier, zone_deep_rift, zone_genesis_point, repair_matter_t1, repair_matter_t2, repair_matter_t3, repair_matter_t4, repair_matter_t5 [INFERRED 0.85]
- **Ship Repair Flow** — HangarCard_component, resources_router, ship_service, repair_mats_config [INFERRED 0.85]
- **Expedition Launch Flow** — ZoneDetailModal_component, expedition_service, fuels_config, galaxy_zones_config [INFERRED 0.85]
- **Player Data Flow to UI** — usePlayerStore, TopBar, HangarPage, LaboratoryPage, SettingsModal, ResourceConverter [INFERRED 0.85]
...
Cohesion: 0.06
Nodes (62): en, la, ru, en, la, ru, en, la (+54 more)

### Community 1 - "Community 1"
Cohesion: 0.17
Nodes (33): name, name, name, name, name, name, name, name (+25 more)
...
Cohesion: 0.08
Nodes (33): max_level, min_level, name, slug, max_level, min_level, name, slug (+25 more)
...
Cohesion: 0.07
Nodes (26): overdrive, damage_chance_percent, essence_drop_multiplier, extra_fuel_required, guaranteed_loot_percent, loot_multiplier, requires_insurance, slug (+18 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (25): auto, description, slug, catastrophic, duration_hours, requires_artifact, resource_cost_multiplier, slug (+17 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (25): Integration-тесты для API эндпоинтов., POST /laboratory/craft без авторизации должен возвращать 401., POST /laboratory/craft с недостатком эссенций должен возвращать 400., GET /config/ с небезопасным именем должен возвращать 404., GET /config/nonexistent должен возвращать 404., GET /auth/me с авторизацией должен возвращать профиль., GET /health должен возвращать 200 со статусом БД и Redis., GET / должен возвращать 200. (+17 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (15): NftItem, TON blockchain client wrapper.  Provides async interface for TON network operati, Mint a Fleet NFT (T4-T5 ships only).          Validates tier >= 4 via config/nft, Mint a 1-of-1 Artifact NFT.          Each unique recipe_hash produces exactly on, Mint a Soul-Bound Pilot SBT (non-transferable).          One SBT per player, bou, Verify a transaction is confirmed on-chain.          Returns True for mock trans, Get the owner address of a specific NFT item.          Returns mock owner in dev, Represents a TON blockchain transaction. (+7 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (24): en, la, ru, top_10, top_100, top_50, season_1, duration_days (+16 more)

### Community 15 - "Community 15"
Cohesion: 0.10
Nodes (13): LaunchButtonProps, BottomNav, tabs, isMuted(), playSound(), SOUND_CONFIGS, SoundConfig, SoundManager (+5 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (22): slug, tier, slug, tier, slug, tier, slug, tier (+14 more)

### Community 17 - "Community 17"
Cohesion: 0.25
Nodes (22): en, la, ru, description, description, description, description, description (+14 more)
...
Cohesion: 0.10
Nodes (20): high, idle, low, medium, artifact_erosion, calibration_cost, default_cycles, floor_percent (+12 more)

### Community 22 - "Community 22"
Cohesion: 0.18
Nodes (21): stats, stats, stats, stats, stats, stats, stats, stats (+13 more)

### Community 23 - "Community 23"
Cohesion: 0.14
Nodes (20): cooldown_seconds, slug, template, cooldown_seconds, slug, template, cooldown_seconds, slug (+12 more)
...
Cohesion: 0.12
Nodes (18): en, la, ru, drop_table, lock_days, name, slug, tier (+10 more)
...
Cohesion: 0.17
Nodes (33): description, description, description, description, description, description, description, en (+25 more)

### Community 36 - "Community 36"
Cohesion: 0.25
Nodes (17): BottomNav, DiscoverersList, HangarPage, LaboratoryPage, ResourceConverter, SettingsModal, ShipModal, TopBar (+9 more)
...
Cohesion: 0.13
Nodes (13): get_expedition(), list_active_expeditions(), Launch a new expedition.      Validates ship ownership, fuel availability, and t, Get expedition details by ID., List all active (pending/in_progress) expeditions for the player., start_expedition(), ActiveExpeditionRead, ExpeditionRead (+5 more)

### Community 45 - "Community 45"
Cohesion: 0.17
Nodes (13): _check_rate_limit_local(), _check_rate_limit_redis(), _get_client_id(), rate_limit_middleware(), RateLimitConfig, Middleware для rate limiting через sliding window algorithm., Извлекает идентификатор клиента из запроса., Проверяет rate limit через Redis (sliding window). (+5 more)

### Community 46 - "Community 46"
Cohesion: 0.21
Nodes (15): Mangan Hydride (T1 Fuel), Methane Fraction (T2 Fuel), Dark Matter (T3 Fuel), Singularity Ether (T4 Fuel), Dark Energy (T5 Fuel), Good Enough Kit (T1 Repair), Garage Tuning Kit (T2 Repair), Anti-Entropy Kit (T3 Repair) (+7 more)

### Community 47 - "Community 47"
Cohesion: 0.14
Nodes (13): royalty_percent, standard, unique_per_hash, min_tier, royalty_percent, standard, nft_minting, artifact_nft (+5 more)

### Community 48 - "Community 48"
Cohesion: 0.15
Nodes (13): lifespan(), Manage startup/shutdown lifecycle: connect DB and Redis., close_engine(), get_db(), init_db(), Async SQLAlchemy engine and session management., FastAPI dependency yielding an async database session., Verify database connectivity with a lightweight query. (+5 more)

### Community 49 - "Community 49"
Cohesion: 0.21
Nodes (13): get_cached_config(), get_json(), get_redis(), get_redis_client(), Async Redis client and helper utilities., Verify Redis connectivity with a PING command., Return the singleton async Redis client, creating it if needed., FastAPI dependency yielding an async Redis connection. (+5 more)
...
Cohesion: 0.17
Nodes (11): promotion_quests, t1_to_t2, t2_to_t3, crate_slug, required_expeditions, required_xp, slug, crate_slug (+3 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (48): apocalypse, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+40 more)

### Community 54 - "Community 54"
Cohesion: 0.30
Nodes (10): React TMA Frontend Entry Point, Artifact Erosion & Staking Yield, Config-Driven Architecture, Dark Cosmic UI Theme, Laboratory & Crafting System, Overdrive Protocol (Risk-Based Gameplay), React TMA Frontend Architecture, Slug System (Immutable Identifiers) (+2 more)

### Community 55 - "Community 55"
Cohesion: 0.18
Nodes (10): artifact_stellar_compass, art_path, crafting_recipe, discovered_at, discovered_by, is_discovered, rarity, slug (+2 more)

### Community 56 - "Community 56"
Cohesion: 0.18
Nodes (10): avatars, default_navigator, image_path, name, slug, tier, unlock_condition, en (+2 more)
...
Cohesion: 0.20
Nodes (10): artifact_chrono_accelerator, art_path, crafting_recipe, discovered_at, discovered_by, is_discovered, rarity, slug (+2 more)
...
Cohesion: 0.20
Nodes (10): artifact_eternal_lantern, art_path, crafting_recipe, discovered_at, discovered_by, is_discovered, rarity, slug (+2 more)

### Community 63 - "Community 63"
Cohesion: 0.20
Nodes (10): artifact_omega_engine, art_path, crafting_recipe, discovered_at, discovered_by, is_discovered, rarity, slug (+2 more)

### Community 64 - "Community 64"
Cohesion: 0.20
Nodes (10): artifact_quantum_core, art_path, crafting_recipe, discovered_at, discovered_by, is_discovered, rarity, slug (+2 more)

### Community 65 - "Community 65"
Cohesion: 0.20
Nodes (10): artifact_singularity_anchor, art_path, crafting_recipe, discovered_at, discovered_by, is_discovered, rarity, slug (+2 more)

### Community 66 - "Community 66"
Cohesion: 0.20
Nodes (10): artifact_void_shield, art_path, crafting_recipe, discovered_at, discovered_by, is_discovered, rarity, slug (+2 more)

### Community 67 - "Community 67"
Cohesion: 0.47
Nodes (10): description, description, description, description, description, description, description, en (+2 more)
...
Cohesion: 0.30
Nodes (29): repair_matter_t1, repair_matter_t2, repair_matter_t3, repair_matter_t4, repair_matter_t5, repair_drop_weights, repair_drop_weights, repair_drop_weights (+21 more)
...
Cohesion: 0.22
Nodes (9): chronos, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 77 - "Community 77"
Cohesion: 0.22
Nodes (9): creator, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 78 - "Community 78"
Cohesion: 0.22
Nodes (9): dominion, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)
...
Cohesion: 0.22
Nodes (9): genesis, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)
...
Cohesion: 0.22
Nodes (9): leviathan, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 84 - "Community 84"
Cohesion: 0.22
Nodes (9): nemesis, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 85 - "Community 85"
Cohesion: 0.22
Nodes (9): odyssey, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 86 - "Community 86"
Cohesion: 0.22
Nodes (9): orion, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 87 - "Community 87"
Cohesion: 0.22
Nodes (9): phoenix, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 88 - "Community 88"
Cohesion: 0.22
Nodes (9): prometheus, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)
...
Cohesion: 0.22
Nodes (9): singularity, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 92 - "Community 92"
Cohesion: 0.22
Nodes (9): stella, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 93 - "Community 93"
Cohesion: 0.22
Nodes (9): vanguard, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)

### Community 94 - "Community 94"
Cohesion: 0.22
Nodes (9): vega, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)
...
Cohesion: 0.24
Nodes (10): HangarCard Component, ShipCard Component, ZoneDetailModal Component, EXO GENESIS FastAPI App, Expedition Service, Fuels Configuration, Galaxy Zones Configuration, Repair Materials Configuration (+2 more)

### Community 98 - "Community 98"
Cohesion: 0.22
Nodes (9): invalidate_config_cache(), Инвалидирует кэш конкретного конфига.      Args:         key: Ключ конфига (напр, get_config(), invalidate_config(), _load_config_sync(), Config router: serves game balance JSON files from config/ with Redis caching., Синхронная загрузка конфига из файла (для передачи в get_cached_config)., Load and return a game config JSON by name with Redis caching.      The name mus (+1 more)

### Community 99 - "Community 99"
Cohesion: 0.20
Nodes (10): 3.1 Механика Ремонта, 3.5 Системные Уведомления, 4.1 Экспедиции (Config-Driven), 4.2 Overdrive Protocol (Config-Driven Risk), 4.3 Artifact Erosion & Staking Yield, 4. Геймплейные Механики, 5. Лаборатория и Крафт, 6. Система Гильдий (+2 more)

### Community 100 - "Community 100"
Cohesion: 0.20
Nodes (10): 1.1 Предыстория, 1.2 Роль Игрока, 1.3 Фракции (v1.5+), 1. Лор и Вселенная, 2.1 Уровни и Ресурсы (Fuel Matrix), 2.2 Прогрессия Пилота (Config-Driven), 2.3 Глобальные UI/UX Стандарты, 2. Игровая Иерархия (+2 more)
...
Cohesion: 0.22
Nodes (9): expedition_deep_rift, damage_chance_percent, duration_hours, fuel_required, loot_table, requires_verification, slug, tier (+1 more)

### Community 116 - "Community 116"
Cohesion: 0.22
Nodes (8): expedition_frontier_outpost, damage_chance_percent, duration_hours, fuel_required, loot_table, slug, tier, xp_reward

### Community 117 - "Community 117"
Cohesion: 0.22
Nodes (9): expedition_genesis_point, damage_chance_percent, duration_hours, fuel_required, loot_table, requires_verification, slug, tier (+1 more)

### Community 118 - "Community 118"
Cohesion: 0.22
Nodes (8): allowed_tiers_for_trade, artifact_trade_enabled, burn_percent_of_fee, ecosystem_percent_of_fee, external_marketplace_url, internal_p2p_enabled, marketplace_fee_percent, royalty_percent

### Community 119 - "Community 119"
Cohesion: 0.22
Nodes (9): nomad, art_path, base_stability, expedition_slots, image_path, is_nft, short_description, slug (+1 more)
...
Cohesion: 0.54
Nodes (8): en, la, ru, description, description, description, description, description

### Community 123 - "Community 123"
Cohesion: 0.54
Nodes (8): name, name, name, name, name, en, la, ru

### Community 124 - "Community 124"
Cohesion: 0.25
Nodes (8): expedition_nebula_extraction, damage_chance_percent, duration_hours, fuel_required, loot_table, slug, tier, xp_reward
...
Cohesion: 0.25
Nodes (7): CraftRequest, CraftResponse, Pydantic schemas for laboratory endpoints., Response for craft attempt., Public recipe info for GET /laboratory/recipes/{hash}., Request body for POST /laboratory/craft., RecipeInfo
...
Cohesion: 0.33
Nodes (5): get_current_player(), Authentication middleware dependencies., Parsed Telegram user data from TMA headers., Extract and validate Telegram user identity from request header.      For MVP: p, TelegramUser

### Community 152 - "Community 152"
Cohesion: 0.29
Nodes (5): health(), EXO GENESIS — FastAPI application entry point., Log every request with method, path, status code, and duration., Health check with DB and Redis status., request_logging()

### Community 153 - "Community 153"
Cohesion: 0.29
Nodes (6): craft_artifact(), get_recipe_info(), list_domains(), Attempt to craft an artifact from essences.      $XGEN is burned 100%. Essences, Return all available galaxy zones for laboratory crafting., Return public recipe info by hash (for marketplace verification).

### Community 154 - "Community 154"
Cohesion: 0.33
Nodes (4): BaseSettings, Application settings loaded from environment variables., Central configuration for EXO GENESIS backend.      All values are read from env, Settings

### Community 155 - "Community 155"
Cohesion: 0.29
Nodes (6): icons, iconUrl, name, privacyPolicyUrl, termsOfUseUrl, url

### Community 156 - "Community 156"
Cohesion: 0.33
Nodes (5): PlayerRead, PlayerUpdate, Pydantic schemas for player-related endpoints., Read-only player profile returned by GET /player/me., Fields that a player can update via PATCH /player/me.

### Community 157 - "Community 157"
Cohesion: 0.40
Nodes (5): main(), CLI-утилита для валидации всех игровых конфигов через Pydantic.  Использование:, Точка входа CLI: валидирует все конфиги и выводит отчёт., Валидирует один JSON-файл через Pydantic-модель.      Args:         filename: Им, validate_config_file()

### Community 158 - "Community 158"
Cohesion: 0.40
Nodes (4): invalidate_all_config_cache(), Инвалидирует весь кэш конфигов.      Returns:         Количество удалённых ключе, main(), Скрипт для сброса кэша всех конфигов в Redis.  Запуск:     cd E:\CryptoProjects\

### Community 159 - "Community 159"
Cohesion: 0.40
Nodes (5): 🤖 AGENT SKILLS & INSTRUCTIONS (EXO GENESIS), 🔑 CORE RULES, 📝 OUTPUT FORMAT, 🚫 STRICT PROHIBITIONS, 🛠️ WORKFLOW (STRICT)

### Community 160 - "Community 160"
Cohesion: 0.40
Nodes (5): 13. Технический Стек & Среда, 14. Архитектура Бэкенда, 15. Архитектура Базы Данных, 16. Смарт-Контракты, ЧАСТЬ III — ТЕХНОЛОГИИ

### Community 161 - "Community 161"
Cohesion: 0.50
Nodes (4): ResourceCard Component, ResourceDetailModal Component, ResourceItemRow Component, ResourcesAccordion Component

### Community 162 - "Community 162"
Cohesion: 0.50
Nodes (4): CosmicMap Component, SectorAccordion Component, ZoneCardCompact Component, ZoneCard Component
...
Cohesion: 0.50
Nodes (3): get_player_me(), Player profile router., Return the current player's profile.      MVP: returns mock data. Production wil

### Community 166 - "Community 166"
Cohesion: 0.50
Nodes (3): main(), Debug one-liner: print player_123 inventory.  Использование:     uv run python s, Выводит инвентарь player_123 из БД.

### Community 167 - "Community 167"
Cohesion: 0.50
Nodes (3): Graphify OpenCode Plugin, plugin, $schema

### Community 172 - "Community 172"
Cohesion: 1.00
Nodes (3): Orion Ship Asset, Hangar Page (Fleet/Resources), Stella Ship Asset
...
Cohesion: 0.29
Nodes (7): vanguard_nebula_ghost, base_stability, expedition_slots, image_path, is_nft, slug, tier
